...
xg_8_5d_71m = optimized_booster_5d_71m
...
# best model overall, save this output
write.csv(stack_8, "data/landsat_estimations/UPDATED_Yojoa_LS-derived_Secchi_estimates.csv")
```
